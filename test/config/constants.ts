...
export const BEE_URL = process.env.CI === 'true' ? 'http://172.18.0.1:1633' : 'http://localhost:1633'
export const BEE_DEBUG_URL = process.env.CI === 'true' ? 'http://172.18.0.1:1635' : 'http://localhost:1635'
